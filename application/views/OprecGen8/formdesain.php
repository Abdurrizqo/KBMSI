    ...
    <div class="isi-form my-3 text-left">
      <form action=" < ?= base_url('OprecstaffGen8/isi_form'); ?> " method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="kukuh" disabled>
        </div>
        ...
        <div class="form-group col-md-6 col-sm-12">
          ...
          <input type="text" class="form-control" value="1851" disabled>
        </div>
      ...
      <div class="row">
      <div class="form-group col-md-6 col-sm-12">
      <label class="control-label">Khusus Weekday</label>
      <select class="form-control" name="waktu1" required>
        <option value="" disabled selected hidden></option>
        <option value="15.00 - 16.00">Jam 15.00 - 16.00</option>
        <option value="16.00 - 17.00">Jam 16.00 - 17.00</option>
        <option value="17.00 - 18.00">Jam 17.00 - 18.00</option>
        <option value="18.00 - 19.00">Jam 19.00 - 20.00</option>
        <option value="20.00 - 21.00">Jam 20.00 - 21.00</option>
      </select>
      </div>

      <div class="form-group col-md-6 col-sm-12">
      <label class="control-label">Khusus weekend</label>
      <select class="form-control" name="waktu2" required>
        <option value="" disabled selected hidden></option>
        <option value="09.00 - 10.00">Jam 09.00 - 10.00</option>
        <option value="11.00 - 12.00">Jam 11.00 - 12.00</option>
        <option value="13.00 - 14.00">Jam 13.00 - 14.00</option>
        <option value="15.00 - 16.00">Jam 15.00 - 16.00</option>
        <option value="17.00 - 18.00">Jam 17.00 - 18.00</option>
      </select>
      </div>
      ...
      <select class="form-control" name="pilkom1" required>
        ...
        <option value="BPM_HUU">Komisi Hukum dan undang-undang</option>
      </select>
      </div>
      </div>
