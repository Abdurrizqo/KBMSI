	...
	<div id="container" class="container-fluid">
		<div class="row">
			<div class="col-lg-5 col-md-12">
				<img src="<?php echo base_url() ?>assets/img/9th/departemen/advokesma.png" alt="" class="logo-lembaga-2 mx-auto d-block d-sm-block logo-lembaga">
			</div>
			<div class="col-lg-6 col-md-12 mt-5 pt-3 mb-5 font-roboto desc-lembaga">
				<h2 class="mt-5 font-candal judul-shadow-blue text-uppercase"><b> DEPARTEMEN ADVOKASI KESEJAHTERAAN MAHASISWA </b></h2>
				<div class="garis-lembaga mb-2"></div>
				<p style="font-size: 18px;">Departemen Advokasi dan Kesejahteraan Mahasiswa adalah departemen yang berperan
					sebagai jembatan antara mahasiswa dan pemangku kebijakan terkait hak-hak mahasiswa KBMSI. Departemen Advokesma
					bergerak dalam melakukan pelayanan dan pengadvokasian terhadap permasalahan-permasalahan yang dialami mahasiswa
					KBMSI terkait akademik, sarana prasarana, serta informasi kemahasiswaan lainnya yang berguna untuk kesejahteraan
					mahasiswa SI UB.</p>
			</div>
		</div>
		...
		<div class="col-md-12 text-center font-roboto" id="anggota-departemen">
			<div class="container-fluid">
				...
				<div class="row justify-content-center bph">
					<div class="col-md-4 col-sm-5 col-12">
						<img src="<?php echo base_url() ?>assets/img/9th/departemen/advokesma/<?= $kadep['file_foto'] ?>" alt="">
				...
				<div class="row justify-content-center bph" style="margin-top: 100px;">
					...
					foreach ($wakadep as $wakadep) : ?>
						<div class="col-md-4 col-sm-6 col-10 ">
							<img class="mt-4" src="<?php echo base_url() ?>assets/img/9th/departemen/advokesma/<?= $wakadep['file_foto'] ?>" alt="">
			...
			<div class="row staff-departemen justify-content-center">
				...
				foreach ($staff as $staff) : ?>
					<div class="col-md-4 col-sm-6 col-10 ">
						<img src="<?php echo base_url() ?>assets/img/9th/departemen/advokesma/<?= $staff['file_foto'] ?>" alt="">
