    ...
    <div id="container" class="container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-12">
                <img src="<?php echo base_url() ?>assets/img/9th/departemen/sosma.png" alt="" class="logo-lembaga-2 mx-auto d-block d-sm-block logo-lembaga">
            </div>
            <div class="col-lg-6 col-md-12 mt-5 pt-3 mb-5 font-roboto desc-lembaga">
                <h2 class="mt-5 font-candal judul-shadow-blue text-uppercase"><b> DEPARTEMEN SOSIAL MASYARAKAT </b></h2>
                <div class="garis-lembaga mb-2"></div>
                <p style="font-size: 18px;">Departemen Sosial Masyarakat merupakan departemen yang
                    bergerak di lingkungan eksternal KBMSI dan melakukan pengabdian masyarakat dengan
                    mengadakan aktivitas sosial yang berkesinambungan. ⁣</p>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center bph">
                    ...
                    <div class="col-md-4 col-sm-5 col-12">
                        <img src="<?php echo base_url() ?>assets/img/9th/departemen/sosma/<?= $kadep['file_foto'] ?>" alt="">
                    ...
                    foreach ($wakadep as $wakadep) : ?>
                        <div class="col-md-4 col-sm-5 col-12 ">
                            <img src="<?php echo base_url() ?>assets/img/9th/departemen/sosma/<?= $wakadep['file_foto'] ?>" alt="">
                ...
                <div class="row staff-departemen justify-content-center">
                    ...
                    foreach ($staff as $staff) : ?>
                        <div class="col-md-4 col-sm-6 col-10 ">
                            <img src="<?php echo base_url() ?>assets/img/9th/departemen/sosma/<?= $staff['file_foto'] ?>" alt="">
