<div class="lembaga-emsi">
    <div id="container" class="container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-12">
                <img src="<?php echo base_url() ?>assets/img/9th/departemen/medkom.png" alt="" class="logo-lembaga-2 mx-auto d-block d-sm-block logo-lembaga">
            </div>
            <div class="col-lg-6 col-md-12 mt-5 pt-3 mb-5 font-roboto desc-lembaga">
                <h2 class="mt-5 font-candal judul-shadow-blue text-uppercase"><b> DEPARTEMEN MULTIMEDIA, KOMUNIKASI DAN INFORMASI </b></h2>
                <div class="garis-lembaga mb-2"></div>
                <p style="font-size: 18px;"> Departemen MEDKOMINFO merupakan departemen yang berperan sebagai
                    pintu⁣ informasi antara internal dan eksternal lembaga EMSI UB. Penyampaian informasi yang⁣
                    dilakukan baik secara tulisan maupun visual melalui media cetak, website, dan social⁣ media.
                    Departemen MEDKOMINFO memberikan informasi mengenai kegiatan-kegiatan yang dilakukan oleh EMSI UB.⁣</p>
            </div>
        </div>
        <div class="col-md-12 text-center font-roboto" id="anggota-departemen">
            <div class="container-fluid">
                ...
                <div class="row justify-content-center bph">
                    <div class="col-md-4 col-sm-5 col-12">
                        <img src="<?php echo base_url() ?>assets/img/9th/departemen/medkominfo/<?= $kadep['file_foto'] ?>" alt="">
                ...
                <div class="row justify-content-center bph" style="margin-top: 100px;">
                    <?php $i = 1;
                    foreach ($wakadep as $wakadep) : ?>
                        <div class="col-md-4 col-sm-6 col-10 ">
                            <img class="mt-4" src="<?php echo base_url() ?>assets/img/9th/departemen/medkominfo/<?= $wakadep['file_foto'] ?>" alt="">
            ...
            <div class="row staff-departemen justify-content-center">
                ...
                foreach ($staff as $staff) : ?>
                    <div class="col-md-4 col-sm-6 col-10 ">
                        <img src="<?php echo base_url() ?>assets/img/9th/departemen/medkominfo/<?= $staff['file_foto'] ?>" alt="">
    ...
    <div class="row">
        ...
        <div class="or28-lembaga"><img src="<?= base_url('assets/img/component/circle-5.png'); ?>" alt="" class="img-fluid"></div>
        <div class="or29-lembaga"><img src="<?= base_url('assets/img/component/kbmsi.png'); ?>" alt="" class="img-fluid"></div>
        <div class="or30-lembaga"><img src="<?= base_url('assets/img/component/star-4.png'); ?>" alt="" class="img-fluid"></div>
    </div>
</div>
<script>
