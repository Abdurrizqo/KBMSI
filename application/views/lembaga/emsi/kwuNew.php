    ...
    <div id="container" class="container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-12">
                <img src="<?php echo base_url() ?>assets/img/9th/departemen/kwu.png" alt="" class="logo-lembaga-2 mx-auto d-block d-sm-block logo-lembaga">
            </div>
            <div class="col-lg-6 col-md-12 mt-5 pt-3 mb-5 font-roboto desc-lembaga">
                <h2 class="mt-5 font-candal judul-shadow-blue text-uppercase"><b> DEPARTEMEN KEWIRAUSAHAAN </b></h2>
                <div class="garis-lembaga mb-2"></div>
                <p style="font-size: 18px;">Departemen Kewirausahaan merupakan departemen yang berperan dalam
                    pencarian⁣⁣ dana secara mandiri yang berguna untuk membiayai setiap kegiatan yang dilakukan⁣ oleh
                    EMSI UB. Departemen Kewirausahaan juga melatih softskill setiap anggota untuk⁣⁣ dapat menggali potensinya
                    dalam bidang wirausaha⁣⁣.</p>
            </div>
        </div>
        ...
        <div class="col-md-12 text-center font-roboto" id="anggota-departemen">
            <div class="container-fluid">
                ...
                <div class="row justify-content-center bph">
                    ...
                    <div class="col-md-4 col-sm-5 col-12">
                        <img src="<?php echo base_url() ?>assets/img/9th/departemen/kwu/<?= $kadep['file_foto'] ?>" alt="">
                    ...
                    foreach ($wakadep as $wakadep) : ?>
                        <div class="col-md-4 col-sm-5 col-12">
                            <img src="<?php echo base_url() ?>assets/img/9th/departemen/kwu/<?= $wakadep['file_foto'] ?>" alt="">
            ...
            <div class="row justify-content-center" style="margin-top: 150px;">
                <h3 class="text-center judul-shadow text-uppercase"><b> Staff Departemen </b></h3>
                <div class="row staff-departemen justify-content-center">

                    <?php $i = 1;
                    foreach ($staff as $staff) : ?>
                        <div class="col-md-4 col-sm-6 col-10 ">
                            <img src="<?php echo base_url() ?>assets/img/9th/departemen/kwu/<?= $staff['file_foto'] ?>" alt="">
