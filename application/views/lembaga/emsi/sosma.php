    ...
    <div class="row mt-5">
        <div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
            <div class="container-fluid">
                <img src="<?php echo base_url() ?>assets/img/8th/departemen/sosma.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
                <h2> DEPARTEMEN SOSIAL MASYARAKAT</h2>
                Departemen Sosial Masyarakat merupakan departemen yang bergerak di lingkungan eksternal KBMSI dan melakukan pengabdian masyarakat dengan mengadakan aktivitas sosial yang berkesinambungan.⁣
