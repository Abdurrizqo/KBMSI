	...
	<div class="row">
		<div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
			<div class="container-fluid">
				<img src="<?php echo base_url() ?>assets/img/8th/departemen/advokesma.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
				<h2> DEPARTEMEN ADVOKASI KESEJAHTERAAN MAHASISWA</h2>
				Departemen Advokasi dan Kesejahteraan Mahasiswa adalah departemen yang berperan sebagai jembatan antara mahasiswa dan pemangku kebijakan terkait hak-hak mahasiswa KBMSI. Departemen Advokesma bergerak dalam melakukan pelayanan dan pengadvokasian terhadap permasalahan-permasalahan yang dialami mahasiswa KBMSI terkait akademik, sarana prasarana, serta informasi kemahasiswaan lainnya yang berguna untuk kesejahteraan mahasiswa SI UB.⁣
				...
				<div class="row d-flex justify-content-center bph">
					...
					foreach ($wakadep as $wakadep) : ?>
						<div class="col-md-4 col-sm-6 col-10 ">
							...
							<h5><?= $wakadep['nama'] ?></h5>
							<p><?= $wakadep['jabatan'] . " " . $wakadep['bidang']?></p>
							<div class="sosial-media">
					...
					<div class="col-md-4 col-sm-5 col-12">
						<img src="<?php echo base_url() ?>assets/img/7th/FOTO_BPH/<?= $wakadep['file_foto'] ?>" alt="">
						<h5><?= $wakadep['nama'] ?></h5>
