    ...
    <div id="container" class="container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-12">
                <img src="<?php echo base_url() ?>assets/img/9th/departemen/psdm.png" alt="" class="logo-lembaga-2 mx-auto d-block d-sm-block logo-lembaga">
            </div>
            <div class="col-lg-6 col-md-12 mt-5 pt-3 mb-5 font-roboto desc-lembaga">
                <h2 class="mt-5 font-candal judul-shadow-blue text-uppercase"><b> DEPARTEMEN PENGEMBANGAN SUMBER DAYA MANUSIA </b></h2>
                <div class="garis-lembaga mb-2"></div>
                <p style="font-size: 18px;"> Departemen PSDM merupakan departemen yang memiliki peran dalam menggali,
                    mengoptimalkan, membina, dan melakukan kaderisasi sumberdaya mahasiswa yang berfokus pada internal dan
                    eksternal EMSI UB. Departemen PSDM juga bertujuan untuk terciptanya pemenuhan aktualisasi diri mahasiswa
                    KBMSI terhadap softskill atau minat bakat dalam bidang non-akademik. ⁣⁣⁣</p>
            </div>
        </div>
                ...
                <div class="row staff-departemen justify-content-center">
                    ...
                    foreach ($staff as $staff) : ?>
                        <div class="col-md-4 col-sm-6 col-10 ">
                            <img src="<?php echo base_url() ?>assets/img/9th/departemen/psdm/<?= $staff['file_foto'] ?>" alt="">
                            <h4 class="mt-2"><b><?= $staff['nama'] ?></b></h5>
                                <div class="sosial-media">
