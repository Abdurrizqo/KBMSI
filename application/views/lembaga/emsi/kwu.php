    ...
    <div class="row">
        <div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
            <div class="container-fluid">
                <img src="<?php echo base_url() ?>assets/img/8th/departemen/kwu.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
                <h2> DEPARTEMEN KEWIRAUSAHAAN</h2>
                Departemen Kewirausahaan merupakan departemen yang berperan dalam pencarian⁣⁣ dana secara mandiri yang berguna untuk membiayai setiap kegiatan yang dilakukan⁣ oleh EMSI UB. Departemen Kewirausahaan juga melatih softskill setiap anggota untuk⁣⁣ dapat menggali potensinya dalam bidang wirausaha⁣⁣
