    ...
    <div class="row">
        <div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
            <div class="container-fluid">
                <img src="<?php echo base_url() ?>assets/img/8th/departemen/medkom.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
                <h2> DEPARTEMEN MULTIMEDIA, KOMUNIKASI DAN INFORMASI </h2>
                Departemen MEDKOMINFO merupakan departemen yang berperan sebagai pintu⁣ informasi antara internal dan eksternal lembaga EMSI UB. Penyampaian informasi yang⁣ dilakukan baik secara tulisan maupun visual melalui media cetak, website, dan social⁣ media. Departemen MEDKOMINFO memberikan informasi mengenai kegiatan-kegiatan yang dilakukan oleh EMSI UB.⁣
