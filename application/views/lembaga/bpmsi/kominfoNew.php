	...
	<div id="container" class="container-fluid">
		<div class="row">
			<div class="col-lg-5 col-md-12">
				<img src="<?php echo base_url() ?>assets/img/9th/komisi/kominfo.png" alt="" class="logo-lembaga-2 mx-auto d-block d-sm-block logo-lembaga">
			</div>
			<div class="col-lg-6 col-md-12 mt-5 pt-3 mb-5 font-roboto desc-lembaga">
				<h2 class="mt-5 font-candal judul-shadow-blue text-uppercase"><b> KOMISI KOMUNIKASI DAN INFORMASI </b></h2>
				<div class="garis-lembaga mb-2"></div>
				<p style="font-size: 18px;">Komisi II Komunikasi dan Informasi merupakan komisi dalam BPMSI yang
					berperan sebagai penghubung pihak internal dengan ekstenal lembaga Keluarga Besar Mahasiswa Sistem
					Informasi yang diperlukan dalam menjalankan fungsi pengawasan, penjaringan aspirasi, maupun legislasi.⁣ </p>
			</div>
		</div>
		...
		<div class="col-md-12 text-center font-roboto" id="anggota-departemen">
			<div class="container-fluid">
				...
				<div class="row justify-content-center bph">
					<div class="col-md-4 col-sm-5 col-12">
						<img src="<?php echo base_url() ?>assets/img/9th/komisi/kominfo/<?= $ketua['file_foto'] ?>" alt="">
				...
				<div class="row justify-content-center bph" style="margin-top: 150px;">
					...
					foreach ($anggota as $anggota) : ?>
						<div class="col-md-4 col-sm-6 col-10">
							<img src="<?php echo base_url() ?>assets/img/9th/komisi/kominfo/<?= $anggota['file_foto'] ?>" alt="">
			...
			<div class="row staff-departemen justify-content-center">
				...
				foreach ($staff as $staff) : ?>
					<div class="col-md-4 col-sm-6 col-10 ">
						<img src="<?php echo base_url() ?>assets/img/9th/komisi/kominfo/<?= $staff['file_foto'] ?>" alt="">
