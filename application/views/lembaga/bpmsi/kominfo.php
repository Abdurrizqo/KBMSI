	...
	<div class="row mt-5">
		...
		<div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
			<div class="container-fluid">
				<img src="<?php echo base_url() ?>assets/img/8th/komisi/kominfo.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
				<h2> KOMISI KOMUNIKASI DAN INFORMASI </h2>
				Komisi II Komunikasi dan Informasi merupakan komisi dalam BPMSI yang berperan sebagai penghubung pihak internal dengan ekstenal lembaga Keluarga Besar Mahasiswa Sistem Informasi yang diperlukan dalam menjalankan fungsi pengawasan, penjaringan aspirasi, maupun legislasi.⁣
		...
		<div class="col-md-8 text-center" id="anggota-departemen">
			<div class="container-fluid">
				<h2 class="text-center text-light mt-5 mb-4"> Ketua dan Anggota Komisi </h2>
				<div class="row d-flex justify-content-center bph">

					<div class="col-md-4 col-sm-6 col-12">
						<img src="<?php echo base_url() ?>assets/img/8th/FOTO_BPH/<?= $ketua['file_foto'] ?>" alt="">
				...
				<div class="row d-flex justify-content-center bph">
					...
					foreach ($anggota as $anggota) : ?>
						<div class="col-md-4 col-sm-6 col-10 ">
							<img src="<?php echo base_url() ?>assets/img/8th/FOTO_BPH/<?= $anggota['file_foto'] ?>" alt="">
							<h5><?= $anggota['nama'] ?></h5>
							<p><?= $anggota['jabatan'] ?></p>
							<div class="sosial-media">
				...
				<!-- staff departemen -->
				<h2 class="text-center text-light mt-5" style="margin-top: 2rem!important;"> Staff Ahli Komisi </h2>
