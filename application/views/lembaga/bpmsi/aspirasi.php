    ...
    <div class="row">
        ...
        <div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
            <div class="container-fluid">
                <img src="<?php echo base_url() ?>assets/img/7th/komisi/aspirasi.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
                <h2> KOMISI ASPIRASI </h2>
                Komisi II Aspirasi merupakan komisi yang bertanggung jawab ⁣⁣dalam penggalian dan pengolahan aspirasi dari KBMSI serta bertanggung jawab dalam mengawasi program kerja Eksekutif Mahasiswa Sistem Informasi dengan rasa tanggung jawab dan terbuka.⁣⁣⁣
            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center bph">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <img src="<?php echo base_url() ?>assets/img/7th/FOTO_BPH/<?= $ketua['file_foto'] ?>" alt="">
                    ...
                    foreach ($anggota as $anggota) : ?>
                        <div class="col-md-4 col-sm-6 col-10 ">
                            <img src="<?php echo base_url() ?>assets/img/7th/FOTO_BPH/<?= $anggota['file_foto'] ?>" alt="">
                            <h5><?= $anggota['nama'] ?></h5>
                            <p><?= $anggota['jabatan'] ?></p>
                            <div class="sosial-media">
                ...
                <div class="row staff-departemen d-flex justify-content-center">
                    ...
                    foreach ($staff as $staff) : ?>
                        <div class="col-md-4 col-sm-6 col-10 ">
                            <img src="<?php echo base_url() ?>assets/img/7th/FOTO_STAFF/<?= $staff['file_foto'] ?>" alt="">
                            <h5><?= $staff['nama'] ?></h5>
                            <p><?= $staff['jabatan'] ?></p>
                            <div class="sosial-media">
