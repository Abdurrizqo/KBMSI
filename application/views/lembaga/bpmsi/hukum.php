	...
	<div class="row">
		...
		<div class="col-md-4 desc-departemen mt-md-5 mb-sm-5 text-sm-center">
			<div class="container-fluid">
				<img src="<?php echo base_url() ?>assets/img/8th/komisi/hukum.png" alt="" style="width: 70%" class="mr-auto ml-auto d-block d-sm-block logo-lembaga mb-5">
				<h2> KOMISI HUKUM</h2>
				Komisi I Hukum merupakan komisi yang bertugas dalam perancangan dan pengawalan produk hukum yang ada di KBMSI, serta bertanggung jawab dalam penyelenggaraan MKBMSI demi menunjang kepentingan dan kebermanfaatan KBMSI.
